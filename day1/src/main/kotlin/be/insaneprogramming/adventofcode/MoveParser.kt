...
class MoveParser {
    fun convertMoveInstructionsToList(line: String): List<Move> = getIndividualMoveInstructions(line).map {
    ...
    private fun getTurnFromMoveString(moveInstruction: String): Turn = when(getTurnInstructionStringFromMoveInstruction(moveInstruction)) {
            "R" -> Turn.RIGHT
            "L" -> Turn.LEFT
